...
public class TestActivity extends Activity implements TestCallBack {
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        manager = TestManager.getTestManager();
        manager.setTestCallBack(this);
    ...
    private void initNative(final String token) {
        CameraNativeHelper.init(TestActivity.this, token,
...
//                    testCallBack.onBdResult(intent,Activity.RESULT_OK);
                    manager.getTestCallBack().onBdResult(intent,Activity.RESULT_OK);
                    finish();
                }
            });
        }
    ...
    @Override
    public void onBdStart() {

    }

    @Override
    public void onBdResult(Intent intent, int resultCode) {

    }

    @Override
    public void onBdResultError() {
